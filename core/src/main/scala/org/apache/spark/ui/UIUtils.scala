...
private[spark] object UIUtils extends Logging {
  ...
  def dataTablesHeaderNodes(request: HttpServletRequest): Seq[Node] = {
    <link rel="stylesheet" href={prependBaseUri(request,
      "/static/jquery.dataTables.2.0.0.min.css")} type="text/css"/>
    <link rel="stylesheet"
          href={prependBaseUri(request, "/static/dataTables.bootstrap4.2.0.0.min.css")}
          type="text/css"/>
    <link rel="stylesheet"
    ...
    <script src={prependBaseUri(request, "/static/jquery.dataTables.2.0.0.min.js")}></script>
    ...
    <script src={prependBaseUri(request, "/static/dataTables.bootstrap4.2.0.0.min.js")}></script>
