 ...
 * `spark.shuffle.service.v411.port` specified in the Yarn configuration. This is so that both the
...
public class YarnShuffleService extends AuxiliaryService {
  ...
  private static final String SPARK_SHUFFLE_SERVICE_PORT_KEY = "spark.shuffle.service.v411.port";
  private static final int DEFAULT_SPARK_SHUFFLE_SERVICE_PORT = 7341;
